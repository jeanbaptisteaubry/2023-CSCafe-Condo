...
INSERT INTO `commande` VALUES (1,'2021-09-22 21:20:18',20,2),(2,'2021-10-07 00:59:58',20,2),(3,'2021-10-07 01:03:28',20,2),(4,'2021-10-07 01:05:53',20,6),(5,'2022-04-07 15:58:35',20,2),(6,'2022-10-12 05:35:27',20,2),(7,'2022-10-12 15:11:23',25,6),(8,'2022-11-09 16:27:53',20,2),(9,'2022-11-09 17:42:01',20,2),(10,'2022-11-09 17:42:28',20,2),(11,'2023-10-19 16:40:38',20,2),(12,'2023-11-06 09:37:07',20,2),(13,'2024-01-25 15:29:17',4,1);
...
INSERT INTO `commande_avoir_article` VALUES (6,128,4,6,0.1),(6,129,3,6,0.1),(7,150,2,7,0.1),(7,152,3,7,0.1),(7,206,2,25,0.1),(8,150,50,7,0.1),(9,150,2,7,0.1),(10,128,4,6,0.1),(10,154,5,7,0.1),(10,196,6,25,0.1),(11,128,5,6,0.1),(11,196,6,25,0.1),(12,206,7,25,0.1),(12,207,3,25,0.1),(13,128,44,6,0.1);
...
INSERT INTO `historique_etat_commande` VALUES (18,6,2,'2022-10-12 05:37:13','Commande passée par userZoomBox userZoomBox',12,-1),(19,7,2,'2022-10-12 15:11:40','Commande passée par test test',13,-1),(20,7,3,'2022-10-12 15:12:16','',-1,18),(21,7,4,'2022-10-12 15:12:28','',-1,18),(22,7,6,'2022-10-12 15:12:31','',-1,18),(23,8,2,'2022-11-09 17:09:46','Commande passée par userZoomBox userZoomBox',12,-1),(24,9,2,'2022-11-09 17:42:04','Commande passée par userZoomBox userZoomBox',12,-1),(25,10,2,'2023-09-14 17:19:11','Commande passée par nomVendeur1 prenomVendeur1',769,-1),(26,11,2,'2023-10-19 16:40:47','Commande passée par nomVendeur2 prenomVendeur2',770,-1),(27,12,2,'2023-11-06 09:37:17','Commande passée par nomVendeur2 prenomVendeur2',770,-1);
...
CREATE TABLE `salarie` (
  ...
  CONSTRAINT `FK_Salarie_Utilisateur` FOREIGN KEY (`idSalarie`) REFERENCES `utilisateur` (`idUtilisateur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-25 15:34:30
